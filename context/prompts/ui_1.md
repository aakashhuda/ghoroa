Create me a mockup of a dashboard page for a project called Ghoroa (Homely Management). A full-stack property management platform built with Nuxt.js (For your convenience use Next.js), enabling building owners and landlords to digitize rent collection, track expenses, manage employees, run a rooftop farm business, and generate financial reports — all from one place.

## **General Feel**

- Minimal and modern
- Information oreanted, light by default
- Inspired by Notion, Linear, Raycast,
- Use Ant Vue (For your convenience use Ant React)
...
- Analytic's Metric,Graph cards in main section with the background color and icon that pertain to the content type within it
- Cards (Total rent, sales, product, popular items & item count, orders, order metrics )
- Sidebar links with icon and text
...
![Dashboard Color Reference](image.png)

**Color Combination Reference**

![Color Combination Ref](image-1.png)

**Final Dashboard Reference**

![Finald Dashboard Reference](image-2.png)
**_Please mantain this kind of subtlety for the rest of the design_**
