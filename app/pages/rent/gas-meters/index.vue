<template>
  <div>
    ...
    >
      ...
      <template #actions>
        <a-button type="primary" class="admin-btn" @click="navigateTo('/rent/gas-meters/add')">
        ...
        <template v-if="column.key === 'actions'">
          <a-space>
            <a-tooltip title="View">
              <a-button class="table-action-btn view-btn" type="text" @click="navigateTo(`/rent/gas-meters/${record.id}`)">
                <EyeOutlined />
              </a-button>
            </a-tooltip>
            <a-tooltip title="Edit">
              <a-button class="table-action-btn edit-btn" type="text" @click="navigateTo(`/rent/gas-meters/edit-${record.id as string}`)">
                <EditOutlined />
              </a-button>
            </a-tooltip>
